...
Today: I don't have measured FAR/FRR. I'm waiting on access to a research-grade iris dataset (PolyU Cross-Spectral primary; CASIA-Iris-V4 parallel fallback) and an FVC-style fingerprint dataset.
